  ...
  return (
    ...
    <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
      ...
      // eslint-disable-next-line @typescript-eslint/no-require-imports
        ...
        <span className="ml-3 text-xl text-orange-800">Dua Irfan Ahmad</span>
      </a>
      <p className="text-sm hover:text-orange-800 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-black-200 sm:py-2 sm:mt-0 mt-4 ">
        © 2024 Designed by DUA IRFAN AHMAD   
      </p>
      <span className="inline-flex sm:ml-auto sm:mt-0 mt-5 justify-center sm:justify-start">
         <Link 
            target="_black"
            href={"https://www.facebook.com/profile.php?id=61554484404288"} className="mr-2 hover:text-blue">
           < PiFacebookLogoBold  className="text-3xl hover:text-[blue]" />
         </Link>
         <Link 
            target="_black"
            href={"https://www.linkedin.com/in/dua-sheikh-8638512b4/"} className="mr-2 hover:text-blue">
           < TiSocialLinkedinCircular  className="text-4xl hover:text-[blue]" />
         </Link>
         <Link 
            target="_black"
            href={"https://github.com/muskandua"} className="mr-2 hover:text-black">
